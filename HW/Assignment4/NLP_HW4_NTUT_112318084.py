...
Original file is located at
    https://colab.research.google.com/drive/1bgQNUC3QxHeUhP7QUq318IWO79VoMkc0
...
# Reference : https://myapollo.com.tw/blog/google-colab-ollama/
...
vector_store = Chroma.from_documents(
    documents=docs,  # Use the documents created from cat-facts.txt
    embedding=embeddings_model  # Use the HuggingFace embeddings model
)
...
system_prompt = """You are a helpful AI assistant designed to answer questions using only the provided context.
Follow these important guidelines:

1. Always base your response strictly on the information in the retrieved documents.
...
4. If multiple documents provide relevant information, synthesize the information
   into a comprehensive answer.
5. Do not invent or fabricate information not present in the source documents.

Context:
{context}

Begin your response by addressing the user's query using only the information from the provided context."""
...
question_answer_chain = create_stuff_documents_chain(
    ...
    prompt  # The prompt template created in the previous step
) # Write your code here

# TODO4-2: Create retrieval chain
# You should create retrieval chain that retrieves documents and then passes them on.
chain = create_retrieval_chain(
    retriever,  # The vector store retriever created earlier
    question_answer_chain  # The document processing chain
) # Write your code here
